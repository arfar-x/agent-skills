...
- `doc_gen(doc_type)` -- a narrower, purpose-built alternative to
  ...
  `skills/trd/SKILL.md`, `skills/adr/SKILL.md`, `skills/rfc/SKILL.md`,
  and `skills/agents-md/SKILL.md`. Adding a new document-generation
  skill (e.g. `skills/erd/SKILL.md` with `metadata.doc_type: erd`) makes
  it appear in `doc_gen`'s enum automatically; nothing in this server needs
